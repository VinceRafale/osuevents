...
if( !class_exists('WPUpdatesPluginUpdater') ) {
    class WPUpdatesPluginUpdater {
    	...
    	function __construct( $api_url, $plugin_id, $plugin_path ) {
    		...
    		add_filter( 'pre_site_transient_update_plugins', array(&$this, 'check_for_update') );
    		add_filter( 'plugins_api', array(&$this, 'plugin_api_call'), 10, 3 );
			if ( is_network_admin() || !is_multisite() ) {
    		add_action('after_plugin_row_Tevolution/templatic.php', 'tevolution_plugin_row' );	  
			}			
