...
if(!$templatic_image_size){ $templatic_image_size = '50000'; }
...
$uc(function()
{
	...
	onComplete: function(file, response)
	{
		/*Image size validation*/
		 if(response == 'LIMIT'){
			status.text('Your image size must be less then '+'<?php echo  $templatic_image_size; ?> bytes');
			return false;
		 }
...
<div id="uploadimage" class="upload" ><span><?php _e("Upload Image", DOMAIN); ?></span></div><span id="status" class="message_error2 clearfix"></span>
