...
<h2><?php _e('Manage user profile fields',DOMAIN);?>  
<a id="add_user_custom_fields"href="<?php echo site_url().'/wp-admin/admin.php?page=user_custom_fields&action=addnew';?>" title="<?php _e('Add a field for users&rsquo; profile',DOMAIN);?>" name="btnviewlisting" class="add-new-h2" /><?php _e('Add a new field',DOMAIN); ?></a>
</h2>

 <p class="description"><?php _e('The fields you add/edit here will be display in user&rsquo;s dashboard and profile area. Using these fields, you can make users fill in custom information about themselves.',DOMAIN);?></p>
