...
if($_POST && !$userInfo)
{
	...
	{
		get_header();
		echo "<div class=error_msg>".__('Email for Contact Details is Empty. Please enter Email, your all information will sent to your Email.')."</div>";	
	...
	{
		echo '<h6><b><a href="'.get_option('siteurl').'/?page=postajob&backandedit=1">Return to '.__(SUBMIT_POST_TEXT).'</a></b></h6>';
		exit;
	}
	...
	$user_address_info = array(
							...
							"first_name"	=>	$_SESSION['custom_fields']['user_fname'],
							);
