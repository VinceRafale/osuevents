...
{
	if(str =='1'){
    jQuery('#rec_tr').slideDown('slow');
    jQuery('#rec_tr1').slideDown('slow');
	}else{
	jQuery('#rec_tr').slideUp('fast');
	jQuery('#rec_tr1').slideUp('fast');
	}
	var recuring = document.getElementById('recurring').value;
	if(recuring == 1){
