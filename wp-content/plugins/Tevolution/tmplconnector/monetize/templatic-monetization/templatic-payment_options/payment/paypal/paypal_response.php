...
$returnUrl = site_url()."?ptype=return&pmethod=paypal&trans_id=".$trans_id;
...
<input type="hidden" value="<?php echo $notify_url;?>&pid=<?php echo $last_postid;?>" name="notify_url"/>
...
<div class="wrapper" >
		<div class="clearfix container_message">
            	<center><h1 class="head2"><?php _e(PAYPAL_MSG);?></h1></center>
         </div>
</div>
<script>
