...
class Geocraft_Widget_Categories extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array('classname' => 'geocraft_widget_categories', 'description' => __("A list or dropdown of categories for place"));
        parent::__construct('custom-categories', __('Geocraft Listing Categories'), $widget_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        if ($d) {
            ...
            echo geocraft_get_terms_dropdown($taxonomies, $args);            
