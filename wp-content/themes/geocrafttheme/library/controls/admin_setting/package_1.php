 ...
 */
?>
<div class="group" id="of-option-package1"> 
    <div class="section section-text ">
        <h3 class="heading"><?php echo PKG_TITLE; ?></h3>
        <div class="option">
            <div class="controls">
...
<!--        <div class="section section-text ">
        <h3 class="heading"><?php echo "Listing Renewal Period"; ?></h3>
        <div class="option">
            <div class="controls">
                <input style="width:150px; margin-right: 15px;" name="renewal_per1" type="text" id="package_fperiod" value="<?php echo $priceinfo[0]->renewal_per; ?>" class="of-biliing" />
                <select style="width:150px;" name="renewal_cycle1" id="package_fday">
                    <?php $valid_period = $priceinfo[0]->renewal_cycle; ?>
                    <option value="D" <?php
                    if ($valid_period == 'D') {
                        echo $validate = 'selected="selected"';
                    } else {
            ...
            <div class="explain"><?php echo "Set the period for renewing the expired listing."; ?>
            </div>
            <div class="clear"> </div>
        </div>
    </div>-->
