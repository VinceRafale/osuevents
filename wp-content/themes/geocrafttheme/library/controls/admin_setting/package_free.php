 ...
 */
?>
<div class="group" id="of-option-packagefree"> 
    ...
    <!--Renewal Period-->
      <div class="section section-text ">
        ...
        <div class="option">
            <div class="controls">
                <input style="width:150px; margin-right: 15px;" name="renewal_per" type="text" id="package_fperiod" value="<?php echo $freeinfo[0]->renewal_per; ?>" class="of-biliing" />
                <select style="width:150px;" name="renewal_cycle" id="package_fday">
