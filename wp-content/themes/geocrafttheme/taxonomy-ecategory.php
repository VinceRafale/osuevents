...
/*Add action for display the bradcrumb in between header and container. */?>
	...
	<div id="content" class="contentarea">
		...
		if (have_posts()) : while (have_posts()) : the_post(); ?>	
			...
			<?php $featured = (apply_filters('tmpl_before_page_image',true) !='')?apply_filters('tmpl_before_page_image',true):get_post_meta(get_the_ID(),'featured_c',true);
						$calss_featured=$featured=='c'?'featured_c':'';
					
			?>		
				<div class="post <?php echo $calss_featured?>">     
					<?php
...
if ( is_active_sidebar( $taxonomy_slug.'_listing_sidebar' ) && $layout !='layout_1c' ) : 
do_atomic( 'before_sidebar_primary' ); // supreme_before_sidebar_primary ?>
	...
	<div id="sidebar-primary" class="sidebar">
		...
		<?php dynamic_sidebar($taxonomy_slug.'_listing_sidebar'); ?>
